...
§1::GOLDEN_RULE
  ...
  MEANING::"Flat lists→information. Relationship networks→understanding."
...
§2::SEVEN_DEADLY_SMELLS
  ...
  CEREMONY_OVERFLOW:
    ...
    IMPACT::"Signal⇌Noise. LLMs extract from structure, not poetry"
  ...
  BURIED_NETWORKS:
    ...
    IMPACT::"LLMs cannot parse prose→graphs"
...
§3::AUTHORING_CHECKLIST
  ...
  DURING::[remove_50%_words?, explicit_keys?, examples>descriptions?]

...
CUE:
  ...
  TEACH::      [ "STRONG: examples embedded alongside schema" + CONST -> §SELF ]
...
OPENAI_FUNCTION_CALLING:
  ...
  VALIDATE::   [ "STRONG: JSON mode ensures parseable output" + CONST -> §SELF ]
...
GUIDANCE:
  ...
  GUARANTEE::  [ "100% guaranteed output structure via steering" + OPT -> §SELF ]

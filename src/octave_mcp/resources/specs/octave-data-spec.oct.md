...
META:
  ...
  CRITICAL_GAPS::[
    compression_rules_enforcement,
    tier_specific_logic,
    loss_profile_tracking
  ]
  CONTRACT::COMPRESSION_TIER<self_declared_in_META>
---
§0::TIER_CONTRACT
...
COMPRESSION_INTENT:
  ...
  UNACCEPTABLE_LOSS::[
    structural_mischaracterization,
...
TIERS:
  ...
  CONSERVATIVE:
    ...
    METHOD::[
      drop_stopwords,
      compress_examples→inline,
      keep_tradeoff_narratives,
      remove_verbose_transitions
    ]
  ...
  AGGRESSIVE:
    ...
    METHOD::[
      drop_stopwords,
      compress_narratives→assertions,
      inline_all_examples,
      remove_historical_context
    ]
  ...
  ULTRA:
    ...
    OUTCOME::"structure∧facts_only,poor_readability"
  ULTRA_MYTHIC:
    TARGET::"60%_compression"
    PRESERVE::[soul∧constraints]
    DROP::narrative
    USE::[
      agent_binding_passport,
      identity_transmission,
      high_density_communication
    ]
    METHOD::[
      mythological_atoms,
      semantic_shorthand,
...
WORKING_EXAMPLES:
  ...
  LOSSLESS:
    ...
    FIDELITY::"100%"
    TOKENS::5600
    CONTENT::complete_original_research
  CONSERVATIVE:
    FILE::survey-octave-5-conservative.oct.md
    FIDELITY::"85-90%"
    TOKENS::4800
    CONTENT::explanatory_depth_preserved
  AGGRESSIVE:
    FILE::survey-octave-5-aggressive.oct.md
    FIDELITY::"70%"
    TOKENS::1800
    CONTENT::analytical_truth_preserved
  ULTRA:
    FILE::survey-octave-5-ultra.oct.md
    FIDELITY::"50%"
    TOKENS::2800
    CONTENT::facts_and_structure_only
ASSESSMENTS:
  LOCATION::"examples/"
...
GUIDES:
  LOCATION::"examples/"
  COMPARISON::"README.md[tier_selection_matrix|use_case_guide]"
TIER_SELECTION::[
